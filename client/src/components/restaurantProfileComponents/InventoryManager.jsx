...
import { 
  ShoppingBasket, Plus, Search, Pencil, Trash2, 
  ChevronRight, Save, ChevronLeft, FileText 
} from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import { Card, SectionHeader, Toolbar, Button, Input, Modal, Th, Td } from "./MenuUI";
import InventoryAdjustModal from "./InventoryAdjustModal";
import InventoryAdjustments from "./InventoryAdjustments"; // 👈 new history component
  ...
  return (
    <Card className="p-6">
      <SectionHeader 
        icon={ShoppingBasket} 
        title="Inventory" 
        subtitle="Track stock levels with reorder alerts." 
      />
      ...
      <Toolbar>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <FileText className="w-4 h-4" /> {showHistory ? "Hide History" : "View Adjustments"}
          </Button>
        </div>
      </Toolbar>
      ...
      {/* Adjustments History (toggle) */}
      {showHistory && <InventoryAdjustments />}
