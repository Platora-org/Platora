...
const AdminProfileSideBar = ({ onLogout, loggedUser }) => {
  ...
  useEffect(() => {
    ...
    } else if (location.pathname.includes("/admin/kycrequests")) {
      setOpenDropdown("Wallet");
    } else {
  ...
  const sidebarItems = [
  {
      ...
      children: [
        ...
        { label: "Analytics", href: "/admin/walletAnalytics" },
        { label: "Transactions", href: "/admin/transactions" },
        { label: "KYC Audit Logs", href: "/admin/auditlogs" },
        { label: "Security Audit Logs", href: "/admin/logsSecurity-audit"},
      ], 
    },
    {
      type: "link",
        ...
        <ul className="space-y-2">
          {sidebarItems.map((item, idx) => {
            ...
            if (item.type === "dropdown") {
              ...
              return (
                <li key={idx}>
                  <details open={isOpen} onToggle={(e) => setOpenDropdown(e.target.open ? item.label : null)} className="group">
